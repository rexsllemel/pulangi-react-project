...
class LumbayaoTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tableData: [],
  ...
  componentDidMount() {
    const fetchData = () => {
      fetch('http://faithvpn.site:5000/lumbayao')
    ...
    return (
      <Grid container>
        <ItemGrid xs={12} sm={12} md={12}>
          <RegularCard
            cardTitle="Lumbayao Node"
            cardSubtitle="Lumbayao Water Level History"
            content={
              <CustomTable
